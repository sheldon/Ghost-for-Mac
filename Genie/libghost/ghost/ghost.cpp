...
CGHost :: CGHost( CConfig *CFG , OutputCallbackFunction outputCallback, void* outputCallbackObject)
{
	...
	LoadIPToCountryData( CFG->GetString( "bot_ip2country" , "ip-to-country.csv") );
...
void CGHost :: EventBNETWhisper( CBNET *bnet, string user, string message )
{
	...
	if ( m_BNETCallback )
	{
		m_BNETCallback( m_BNETCallbackObject, bnet, user, message, BNETMessageTypeWhisper );
	}
}
...
void CGHost :: EventBNETChat( CBNET *bnet, string user, string message )
{
	...
	if ( m_BNETCallback )
	{
		m_BNETCallback( m_BNETCallbackObject, bnet, user, message, BNETMessageTypeChat );
	}
}
...
void CGHost :: EventBNETEmote( CBNET *bnet, string user, string message )
{
	...
	if ( m_BNETCallback )
	{
		m_BNETCallback( m_BNETCallbackObject, bnet, user, message, BNETMessageTypeEmote );
	}
}
...
void CGHost :: LoadIPToCountryData( string filename )
{
	ifstream in;
...
void CGHost :: RegisterBNETCallback(EventBNETMessageCallback callback, void* callbackObject)
{
