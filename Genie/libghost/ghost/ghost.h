...
typedef void (*OutputCallbackFunction)(const std::string &message, void* callbackObject );
typedef enum BNETMessageType {
	BNETMessageTypeWhisper,
	BNETMessageTypeChat,
...
public:
	...
	void ExtractScripts( );
	void LoadIPToCountryData( string filename );
